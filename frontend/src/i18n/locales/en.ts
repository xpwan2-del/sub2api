export default {
  ...
  nav: {
    ...
    upstreamSources: 'Price Sources',
    upstreamPriceChanges: 'Price Changes',
    upstreamPriceCompare: 'Price Compare',
  },

  // Upstream Price Sync
  upstreamPricing: {
    sources: {
      description: 'Configure upstream price sources (OpenAI / Anthropic / Gemini) and sync official pricing on a schedule',
      create: 'New Source',
      edit: 'Edit Source',
      name: 'Name',
      baseUrl: 'Base URL',
      ...
      minutes: 'min',
      enabled: 'Enabled',
      modelAliasMap: 'Model Alias Map',
      modelAliasMapHint: 'Map upstream model names to local model names, as JSON',
      modelAliasMapInvalid: 'Model alias map is not valid JSON',
      lastSync: 'Last Sync',
      testConnection: 'Test Connection',
      syncNow: 'Sync Now',
      testOk: 'Reachable — found {count} models',
      testFailed: 'Connection failed',
      syncStarted: 'Sync triggered',
      syncSuccess: 'Sync succeeded',
      syncFailed: 'Sync failed',
      syncRunning: 'Running',
      syncNever: 'Never',
      nameRequired: 'Name is required',
      urlRequired: 'Base URL and pricing endpoint are required',
      deleteConfirm: 'Delete source "{name}"?',
    },
    changes: {
      description: 'Review upstream price changes: follow cost, lock sale price, or dismiss',
      ...
      status: 'Status',
      detectedAt: 'Detected',
      followCost: 'Follow Cost',
      followCostHint: 'Sync local price to upstream cost',
      lockPrice: 'Lock Price',
      lockPriceHint: 'Keep local sale price unchanged, record cost only',
      dismiss: 'Dismiss',
      mode: 'Mode',
      targetId: 'Target ID (channel/group, optional)',
      targetIdPlaceholder: 'Leave empty for server default',
      targetIdHint: 'ID of the channel or group to update; empty = backend default strategy',
      targetChannel: 'Target Channel',
      targetGroup: 'Target Group',
      targetChannelPlaceholder: 'Select a channel to follow cost',
      targetGroupPlaceholder: 'Select a group to lock price',
      targetChannelHint: 'Update this channel\'s per-token price to match upstream cost.',
      targetGroupHint: 'Adjust this group\'s rate multiplier to keep the sale price unchanged.',
      noTargets: 'No matching channels/groups found',
      dismissConfirm: 'Dismiss this price change?',
      ...
      statusFailed: 'Failed',
      batchFollowCost: 'Batch Follow Cost',
      batchWarning: 'Apply follow_cost to all pending changes',
      batchApplied: '{success} applied, {failed} failed',
      collateralWarning: 'Lock price warning',
      revert: 'Revert',
      revertConfirm: 'Revert this change? Channel price and group multiplier will be restored to pre-apply values.',
      reverted: 'Change reverted',
      revertedLabel: 'Reverted',
    },
    compare: {
      description: 'Compare upstream reference price vs local channel price',
