export default {
  ...
  nav: {
    ...
    bundles: '套餐订阅',
    bundleUsage: '套餐用量',
    upstreamPricing: '上游价格',
    upstreamSources: '价格源',
    upstreamPriceChanges: '价格变动',
    upstreamPriceCompare: '价格对比',
  },

  // Upstream Price Sync (上游价格同步)
  upstreamPricing: {
    sources: {
      description: '配置上游价格源（OpenAI / Anthropic / Gemini 等），定时同步官方定价',
      create: '新建价格源',
      edit: '编辑价格源',
      name: '名称',
      baseUrl: 'Base URL',
      ...
      minutes: '分钟',
      enabled: '启用',
      modelAliasMap: '模型别名映射',
      modelAliasMapHint: '将上游模型名映射到本地模型名，JSON 格式',
      modelAliasMapInvalid: '模型别名映射 JSON 格式错误',
      lastSync: '最近同步',
      testConnection: '测试连接',
      syncNow: '立即同步',
      testOk: '连接成功，共发现 {count} 个模型',
      testFailed: '连接失败',
      syncStarted: '同步已触发',
      syncSuccess: '同步成功',
      syncFailed: '同步失败',
      ...
      syncNever: '未同步',
      nameRequired: '请输入名称',
      urlRequired: '请输入 Base URL 与价格接口路径',
      deleteConfirm: '确定删除价格源「{name}」？',
    },
    changes: {
      description: '审阅上游价格变动，选择跟随成本、锁死售价或忽略',
      allSources: '全部价格源',
      source: '价格源',
      model: '模型',
      priceChange: '价格变动',
      ...
      detectedAt: '检测时间',
      followCost: '跟随成本',
      followCostHint: '按上游成本同步本地价格',
      lockPrice: '锁死售价',
      lockPriceHint: '保持本地售价不变，仅记录成本',
      dismiss: '忽略',
      mode: '处理方式',
      targetId: '目标 ID（渠道/渠道组，可选）',
      targetIdPlaceholder: '留空则按服务端默认规则',
      targetIdHint: '指定要更新的 channel 或 group 的 ID；不填则按后端默认策略应用',
      targetChannel: '目标渠道',
      targetGroup: '目标分组',
      targetChannelPlaceholder: '选择跟随成本的渠道',
      targetGroupPlaceholder: '选择锁价的分组',
      targetChannelHint: '将该渠道的每 token 单价更新为上游成本。',
      targetGroupHint: '调整该分组的计费倍率，维持售价不变。',
      noTargets: '未找到匹配的渠道/分组',
      dismissConfirm: '确定忽略该价格变动？',
      applied: '已应用',
      dismissed: '已忽略',
      statusPending: '待处理',
      statusApplied: '已应用',
      statusDismissed: '已忽略',
      statusFailed: '失败',
      batchFollowCost: '批量跟随成本',
      batchWarning: '对所有待处理变动应用 follow_cost',
      batchApplied: '成功 {success} 条，失败 {failed} 条',
      collateralWarning: '锁价警告',
      revert: '撤销',
      revertConfirm: '确认撤销？将恢复 apply 前的 channel 单价和分组倍率',
      reverted: '已撤销变动',
      revertedLabel: '已撤销',
    },
    compare: {
      description: '上游参考价 vs 本地渠道价的差异对比',
      selectSource: '选择价格源',
      model: '模型',
      upstreamRef: '上游参考价',
      localPrice: '本地渠道价',
  ...
  // Admin Notifications (管理员站内通知)
  adminNotifications: {
    title: '管理通知',
    markAllRead: '全部已读',
    allMarkedAsRead: '已全部标记为已读',
    empty: '暂无未读通知',
    emptyDescription: '所有通知都已处理',
  },
