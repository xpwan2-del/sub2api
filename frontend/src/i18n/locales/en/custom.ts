...
export default {
  ...
  admin: {
    catalogManage: {
      ...
      saveSettings: 'Save',
      settingsSaved: 'New model window saved',
      settingsSaveFailed: 'Failed to save new model window',
      pinnedSection: 'Pinned models',
      ...
      colTags: 'Operator tags',
      colAutoTags: 'Auto tags',
      colFeaturedUntil: 'Featured until',
      colStatus: 'Status',
      colActions: 'Actions',
