...
const adminNavItems = computed((): NavItem[] => {
  const baseItems: NavItem[] = [
    ...
    {
      path: '/admin/upstream-pricing',
      label: t('nav.upstreamPricing'),
      icon: DatabaseIcon,
      hideInSimpleMode: true,
      expandOnly: true,
      children: [
        { path: '/admin/upstream-pricing/sources', label: t('nav.upstreamSources'), icon: DatabaseIcon },
        { path: '/admin/upstream-pricing/changes', label: t('nav.upstreamPriceChanges'), icon: BoltIcon },
        { path: '/admin/upstream-pricing/compare', label: t('nav.upstreamPriceCompare'), icon: ChartIcon },
      ],
    },
