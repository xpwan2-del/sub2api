            ...
            <div class="flex items-center gap-3 p-4 border-b border-primary-100 dark:border-dark-700">
              ...
              <div class="flex-1 min-w-0">
                <div class="flex items-center gap-2">
                  ...
                  <span v-if="activePlan?.featured" class="rounded-full border border-primary-500/30 bg-primary-500/10 px-2 py-0.5 text-[11px] font-medium text-primary-600 dark:text-primary-400">
