...
func provideCleanup(
	...
	upstreamBalanceMonitor *service.UpstreamBalanceMonitorService,
) func() {
	return func() {
		...
		parallelSteps := []cleanupStep{
			...
			{"UpstreamBalanceMonitorService", func() error {
				if upstreamBalanceMonitor != nil {
					upstreamBalanceMonitor.Stop()
				}
				return nil
			}},
