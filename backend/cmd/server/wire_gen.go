...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	bundleUsageRepository := repository.NewBundleUsageRepository(client)
	bundleSubscriptionRepository := repository.NewBundleSubscriptionRepository(client)
	bundlePlanRepository := repository.NewBundlePlanRepository(client)
	bundleUsageService := service.NewBundleUsageService(bundleUsageRepository, bundleSubscriptionRepository, bundlePlanRepository)
	gatewayService := service.NewGatewayService(accountRepository, groupRepository, usageLogRepository, usageBillingRepository, userRepository, userSubscriptionRepository, userGroupRateRepository, gatewayCache, configConfig, schedulerSnapshotService, concurrencyService, billingService, rateLimitService, billingCacheService, identityService, httpUpstream, deferredService, claudeTokenProvider, sessionLimitCache, rpmCache, digestSessionStore, settingService, tlsFingerprintProfileService, channelService, modelPricingResolver, balanceNotifyService, serviceUserPlatformQuotaRepository, bundleUsageService)
	...
	bundleSubscriptionService := service.NewBundleSubscriptionService(bundleSubscriptionRepository, bundlePlanRepository, bundleUsageRepository, userSubscriptionRepository, billingCache)
	...
	paymentService := service.ProvidePaymentService(client, registry, defaultLoadBalancer, redeemService, subscriptionService, bundleSubscriptionService, paymentConfigService, userRepository, groupRepository, affiliateService, notificationEmailService)
	...
	adminSubscriptionHandler := admin.NewSubscriptionHandler(subscriptionService, bundleSubscriptionService)
	...
	bundlePlanService := service.NewBundlePlanService(bundlePlanRepository, billingCache)
	bundleAdminHandler := admin.NewBundleAdminHandler(bundlePlanService, bundleSubscriptionService, adminService)
	complianceHandler := admin.NewComplianceHandler(settingService)
	upstreamPriceRepository := repository.NewUpstreamPriceRepository(client)
	upstreamPriceSourceService := service.NewUpstreamPriceSourceService(upstreamPriceRepository, secretEncryptor, httpUpstream)
	channelPricingWriter := service.NewChannelPricingWriterAdapter(channelService)
	groupRateWriter := service.NewGroupRateWriterAdapter(groupRepository)
	applyTargetReader := service.NewApplyTargetReaderAdapter(channelService)
	auditLogger := service.NewSlogAuditLogger()
	upstreamPriceApplyService := service.NewUpstreamPriceApplyService(upstreamPriceRepository, channelPricingWriter, groupRateWriter, applyTargetReader, auditLogger)
	adminNotificationRepository := repository.NewAdminNotificationRepository(client)
	adminNotificationService := service.NewAdminNotificationService(adminNotificationRepository)
	groupRateReader := service.NewGroupRateReaderAdapter(groupRepository)
	alertRecipientReader := service.NewAlertRecipientReaderAdapter(opsService)
	upstreamPriceSyncService := service.ProvideUpstreamPriceSyncService(upstreamPriceRepository, adminNotificationService, notificationEmailService, groupRateReader, alertRecipientReader, opsRepository, redisClient, secretEncryptor, httpUpstream, configConfig)
	upstreamPriceHandler := admin.NewUpstreamPriceHandler(upstreamPriceSourceService, upstreamPriceApplyService, upstreamPriceSyncService)
	adminNotificationHandler := admin.NewAdminNotificationHandler(adminNotificationService)
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler, channelMonitorHandler, channelMonitorRequestTemplateHandler, contentModerationHandler, paymentHandler, affiliateHandler, bundleAdminHandler, complianceHandler, upstreamPriceHandler, adminNotificationHandler)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, channelMonitorUserHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, handlerPaymentHandler, paymentWebhookHandler, availableChannelHandler, bundleHandler, idempotencyCoordinator, idempotencyCleanupService)
