...
func (m *billingCacheMissStub) GetBundleSubscriptionCache(context.Context, int64) (*BundleSubscriptionCacheData, error) {
	return nil, nil
}
func (m *billingCacheMissStub) SetBundleSubscriptionCache(context.Context, int64, *BundleSubscriptionCacheData, time.Duration) error {
	return nil
}
func (m *billingCacheMissStub) InvalidateBundleSubscriptionCache(context.Context, int64) error {
	return nil
}
func (m *billingCacheMissStub) GetBundlePlansForSaleCache(context.Context) ([]byte, error) {
	return nil, nil
}
func (m *billingCacheMissStub) SetBundlePlansForSaleCache(context.Context, []byte, time.Duration) error {
	return nil
}
