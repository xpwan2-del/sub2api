...
func (m *billingCacheWorkerStub) GetBundleSubscriptionCache(context.Context, int64) (*BundleSubscriptionCacheData, error) {
	return nil, nil
}
func (m *billingCacheWorkerStub) SetBundleSubscriptionCache(context.Context, int64, *BundleSubscriptionCacheData, time.Duration) error {
	return nil
}
func (m *billingCacheWorkerStub) InvalidateBundleSubscriptionCache(context.Context, int64) error {
	return nil
}
func (m *billingCacheWorkerStub) GetBundlePlansForSaleCache(context.Context) ([]byte, error) {
	return nil, nil
}
func (m *billingCacheWorkerStub) SetBundlePlansForSaleCache(context.Context, []byte, time.Duration) error {
	return nil
}
