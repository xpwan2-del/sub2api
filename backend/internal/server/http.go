...
func ProvideRouter(
	...
	return SetupRouter(r, handlers, jwtAuth, adminAuth, apiKeyAuth, bundleRouteResolver, apiKeyService, subscriptionService, opsService, settingService, cfg, redisClient)
}
