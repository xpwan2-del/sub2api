...
func SetupRouter(
	...
	bundleRouteResolver *middleware2.BundleRouteResolverMiddleware,
	...
	// 注册路由
	registerRoutes(r, handlers, jwtAuth, optionalJWTAuth, adminAuth, apiKeyAuth, bundleRouteResolver, auditLog, stepUpAuth, apiKeyService, subscriptionService, opsService, settingService, compositeResolver, cfg, redisClient)
...
func registerRoutes(
	...
	// 注册各模块路由
	routes.RegisterPublicModelRoutes(v1, h)
	...
	routes.RegisterBundleRoutes(v1, h, gin.HandlerFunc(jwtAuth))
	routes.RegisterGatewayRoutes(r, h, apiKeyAuth, bundleRouteResolver, apiKeyService, subscriptionService, opsService, settingService, compositeResolver, cfg)
